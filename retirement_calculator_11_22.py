    ...
    if st.session_state.show_optimizer:
        ...
        with st.spinner(f"Solving for {target_conf}% Probability..."):
            if base_prob < 50:
                ...
                desc_a = "Requires increasing your savings rate. Speak with a [NerdWallet Wealth Partner](https://nerdwalletwealthpartners.com/) to help achieve your goals"
                desc_b = "Requires delaying retirement to accumulate more. Speak with a [NerdWallet Wealth Advisor](https://nerdwalletwealthpartners.com/) to help achieve your goals"
